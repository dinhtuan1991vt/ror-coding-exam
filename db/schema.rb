...
ActiveRecord::Schema.define(version: 20180407044650) do

  create_table "developer_languages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "developer_id"
    t.bigint "language_id"
    t.index ["developer_id", "language_id"], name: "index_developer_language_unique", unique: true
  ...
  create_table "developer_programming_languages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["developer_id", "programming_language_id"], name: "index_developer_programming_language_unique", unique: true
